                ...
                for(var j = 1; j < 5; j++){
                    ...
                    solcounter++;
                        if(solcounter == 16){
                            ...
                            setTimeout(document.getElementById('image1').style.visibility='visible', delay);
                            stopClock = true;
                        }
                    }
                }
        ...
        for(var i = 0; i < 6; i++){
            for(var j = 0; j < 6; j++){
                ...
                if(tempGrid[i][j] == "zero"){
                    ...
                    var tdiv1 = newDiv1.clone();
                    var tdiv2 = newDiv2.clone();
...
function getDiff() {
    var diff = document.getElementById("shuffleDiff");
